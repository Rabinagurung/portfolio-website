    ...
    <>
      ...
      <div className='w-full flex'>
        ...
        >
          ...
          real-world examples of my work. Each project includes a brief overview,
          source code, and a live demo where available. They reflect my
          ability to solve complex problems, work with different technologies,
          and manage projects effectively.
        </motion.p>
      </div>

      <div className='mt-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 auto-rows-fr gap-7'>
